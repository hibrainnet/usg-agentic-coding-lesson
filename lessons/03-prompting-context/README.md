...
| 5~20분 | **핵심 커맨드 실전** — 상황별로 언제 어떤 커맨드를 쓰는가 | 따라하기 | `tutorials/00-key-commands.md` |
| 20~35분 | **효과적인 프롬프팅** — 좋은 요청의 구조와 비교 실습 | 강의 + 따라하기 | `docs/01-effective-prompting.md` · `tutorials/01-prompt-comparison.md` |
| 35~50분 | **CLAUDE.md 작성** — `/init`으로 생성, 규칙 추가, 효과 확인 | 따라하기 | `tutorials/02-create-claude-md.md` |
| 50~57분 | **계획 모드** — `/plan`으로 복잡한 작업 사전 설계 | 따라하기 | `tutorials/03-plan-mode.md` |
| 57~60분 | Q&A + 다음 시간 예고 | — | — |
...
- `docs/02-context-management.md` — CLAUDE.md, `/compact`, 계획 모드
