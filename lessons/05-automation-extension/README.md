...
| 5~20분 | **스킬(Skill)** — 반복 작업을 나만의 명령어로 (커스텀 커맨드 통합) | 강의 + 따라하기 | `docs/01-skills.md` · `tutorials/01-skills.md` |
| 20~35분 | **훅(Hooks)** — 특정 이벤트에 자동 실행 | 강의 + 따라하기 | `docs/02-hooks.md` · `tutorials/02-hooks.md` |
| 35~47분 | **MCP 서버** — 외부 도구 연결 | 강의 + 따라하기 | `docs/03-mcp.md` · `tutorials/03-mcp.md` |
| 47~57분 | **서브에이전트** — 작업 위임 패턴 | 강의 + 따라하기 | `docs/04-subagents.md` · `tutorials/04-subagents.md` |
| 57~60분 | Q&A + 다음 시간 예고 | — | — |
...
### 개념 문서
- `docs/01-skills.md` — 스킬(Skill) 구조와 작성법, 커스텀 커맨드와의 관계
- `docs/02-hooks.md` — 훅 개념과 이벤트 종류
- `docs/03-mcp.md` — MCP 개념과 서버 연결 방법
- `docs/04-subagents.md` — 서브에이전트 개념과 비교표

### 실습 튜토리얼 (순서대로 진행)
1. `tutorials/01-skills.md` — **스킬 만들기** (15분)
2. `tutorials/02-hooks.md` — **훅 설정** (15분)
3. `tutorials/03-mcp.md` — **MCP 서버 연결** (12분)
4. `tutorials/04-subagents.md` — **서브에이전트** (10분)
