...
## Step 4: task_manager.py 수정 후 pytest 자동 실행 훅 (공통)
...
실행 명령어:
  cd lessons/05-automation-extension/examples/task-manager && python -m pytest --tb=short -q
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "cd lessons/05-automation-extension/examples/task-manager && python -m pytest --tb=short -q || true"
          }
        ]
      }
    ]
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "cd lessons/05-automation-extension/examples/task-manager && python -m pytest --tb=short -q"
          }
        ]
      }
    ]
