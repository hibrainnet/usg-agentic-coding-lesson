...
| 시간 | 내용 | 형태 | 자료 |
|------|------|------|------|
| 0~5분 | 오리엔테이션: 6시간 강의 전체 흐름 안내 | 강의 | `../../LESSONS.md` |
| 5~30분 | Agentic Coding이란? 패러다임의 변화·작업 루프·한계 | 강의 | `docs/01-what-is-agentic-coding.md` |
| 30~45분 | Claude Code 깊이 보기: 정체·특징·권한·도구 비교 | 강의 | `docs/02-why-claude-code.md` |
