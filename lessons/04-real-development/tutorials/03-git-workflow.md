...
```bash
git add lessons/04-real-development/examples/task-manager/task_manager.py
git add lessons/04-real-development/examples/task-manager/test_task_manager.py
```
